...
#SBATCH --output=/home/wang9418/family_variance/codes/logs/run_simulate_phenotypes_crosses-%A_%a.out
#SBATCH --error=/home/wang9418/family_variance/codes/logs/run_simulate_phenotypes_crosses-%A_%a.err
...
# echo job_done
module load R/4.2.2
Rscript codes/simulate_phenotypes_crosses.R $name
